...
public class ScreeningControllerUnitTest {
    ...
    public void getScreenings() throws Exception {
        this.mockMvc.perform(get("/screenings?date=2022-05-25")).andDo(print()).andExpect(status().isOk()).andExpect(content().string(containsString("")));
    ...
    public void testBookSeats() throws Exception {
        ...
        aMovieScreening.setScreeningDate("2022-09-27");
